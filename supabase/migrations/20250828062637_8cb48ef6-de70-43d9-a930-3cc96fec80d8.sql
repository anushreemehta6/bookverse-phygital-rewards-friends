...
('Harry Potter and the Sorcerers Stone', 'J.K. Rowling', 'Fantasy', 'The first book in the magical Harry Potter series', '/placeholder.svg'),
...
('The Handmaids Tale', 'Margaret Atwood', 'Dystopian Fiction', 'A dystopian novel about reproductive rights', '/placeholder.svg'),
